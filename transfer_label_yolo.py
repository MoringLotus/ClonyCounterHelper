...
def convert_json_to_yolo(json_folder, image_folder, output_folder):
    """
    将 JSON 格式的标注转换为 YOLO 格式的标注文件，并动态生成类别编号。
        ...
        if json_file.endswith(".json"):
            ...
            for label in data["labels"]:
                ...
                if class_name not in class_to_id:
                    class_to_id[class_name] = len(class_to_id)  # 动态分配类别编号
...
# 设置文件夹路径
json_folder = "/home/featurize/work/bhintern/yolodata/train/labels"  # JSON 文件所在的文件夹路径
image_folder = "/home/featurize/work/bhintern/yolodata/train/images"  # 图像文件所在的文件夹路径
output_folder = "/home/featurize/work/bhintern/yolodata/train/yololabels"  # 输出 YOLO 标注文件的文件夹路径
